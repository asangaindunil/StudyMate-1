...
public class FridaySessionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_friday_session);

        actionBar = getSupportActionBar();
        actionBar.setDisplayHomeAsUpEnabled(true);
        actionBar.setTitle("Friday Study Sessions");
        ...
        sessionCardAdapter.setOnItemClickListener(new SessionCardAdapter.OnItemClickListener() {
            ...
            public void onItemClick(int position) {
                ...
                Intent intent = new Intent(FridaySessionActivity.this, ViewSessionActivity.class);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(FridaySessionActivity.this, AddSessionActivity.class);
                startActivity(intent);
            }
        });
    }
